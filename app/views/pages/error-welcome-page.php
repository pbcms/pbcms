...
<p>
    <?php echo str_replace("{{SITE_LOCATION}}", SITE_LOCATION, $lang->get('error-pages.error-welcome-page.content-1', "Welcome to your new PCBMS instance, this is a small introduction page. <br>Start by <a href='{{SITE_LOCATION}}pb-auth'>signin in to your account</a> and by exploring the dashboard!")); ?>
</p>
