    ...
    class AddAccessTokenExpirationPolicy__1__0_0_3 {
        public function up($db) {
            ...
            if ($res->num_rows == 0) {
                ...
                \Core::PrintLine("Entry for policy \"access-token-expiration\" already exists, not overriding it.");
            }
        }
        ...
        public function down($db) {
            ...
            if ($res->num_rows == 0 || intval($res->fetch_assoc()['value']) === 3600) {
                ...
                \Core::PrintLine("Non-default value for policy \"access-token-expiration\" was found, not deleting the entry.");
            }
        }
    }