    ...
    class AddTokenDefaultExpirationPolicy__4__0_0_2 {
        public function up($db) {
            ...
            if ($res->num_rows == 0) {
                ...
                \Core::PrintLine("Entry for policy \"token-default-expiration\" already exists, not overriding it.");
            }
        }
        ...
        public function down($db) {
            ...
            if ($res->num_rows == 0 || intval($res->fetch_assoc()['value']) === 86400) {
                ...
                \Core::PrintLine("Non-default value for policy \"token-default-expiration\" was found, not deleting the entry.");
            }
        }
    }