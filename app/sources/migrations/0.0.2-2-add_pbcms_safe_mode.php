    ...
    class AddPbcmsSafeMode__2__0_0_2 {
        public function up($db) {
            ...
            if ($res->num_rows == 0) {
                ...
                \Core::PrintLine("Entry for policy \"pbcms-safe-mode\" already exists, not overriding it.");
            }
        }
        ...
        public function down($db) {
            ...
            if ($res->num_rows == 0 || intval($res->fetch_assoc()['value']) === 0) {
                ...
                \Core::PrintLine("Non-default value for policy \"pbcms-safe-mode\" was found, not deleting the entry.");
            }
        }
    }