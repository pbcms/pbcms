    ...
    class AddSessionDefaultExpirationPolicy__3__0_0_2 {
        public function up($db) {
            ...
            if ($res->num_rows == 0) {
                ...
                echo "Entry for policy \"session-default-expiration\" already exists, not overriding it." . PHP_EOL;
            }
        }
        ...
        public function down($db) {
            ...
            if ($res->num_rows == 0 || intval($res->fetch_assoc()['value']) === 86400) {
                ...
                echo "Non-default value for policy \"session-default-expiration\" was found, not deleting the entry." . PHP_EOL;
            }
        }
    }